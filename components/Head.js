...
const defaultOGURL = 'https://octoprofile.michaelfrenkel.now.sh';
const defaultOGImage = 'https://octoprofile.michaelfrenkel.now.sh/static/og.png';
...
const Head = props => (
  <NextHead>
    ...
    <meta name="twitter:creator" content={'@mishafrenkel'} />
